...
def taxi_trips(context: dg.AssetExecutionContext, database: DuckDBResource) -> None:
    """
        The raw taxi trips dataset, loaded into  duckdb partitioned by month
    """
    ...
    query = f"""
        ...
        select
            ...
            tpep_dropoff_datetime, tpep_pickup_datetime, trip_distance, passenger_count,
            total_amount, '{month_to_fetch}' as partition_date
...
def taxi_zones(database: DuckDBResource) -> None:
    """
        Create taxi zones table in duckdb
    """
    query = f"""
